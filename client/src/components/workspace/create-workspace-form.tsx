...
export default function CreateWorkspaceForm() {
  ...
  return (
    <main className="w-full flex flex-row min-h-[590px] h-auto max-w-full bg-blue-950 text-white">
      <div className="h-full px-10 py-10 flex-1">
        <div className="mb-5">
          <h1
            className="text-2xl tracking-[-0.16px] dark:text-[#D3D3D3] font-semibold mb-1.5
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className="mb-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="dark:text-[#D3D3D3] text-sm">
                      Workspace name
                    </FormLabel>
                    <FormControl>
                      <Input
      ...
      bg-[url('/images/project.jpeg')] bg-cover bg-center h-full
      "
      />
    </main>
  );
